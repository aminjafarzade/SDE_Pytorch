#!/bin/bash
# Server 4 ODE: vp/cifar10_ddpmpp (ODE version)
...
python main.py \
  --config /home/juhyeong/SDE_Pytorch/configs/vp/cifar10_ddpmpp_ode.py \
  --workdir /home/juhyeong/SDE_Pytorch/exp/vp/cifar10_ddpmpp_ode \
  --mode eval
