#!/bin/bash
# Server 3: vp/cifar10_ddpmpp_continuous
...
python main.py \
  --config /home/juhyeong/SDE_Pytorch/configs/vp/cifar10_ddpmpp_continuous.py \
  --workdir /home/juhyeong/SDE_Pytorch/exp/vp/cifar10_ddpmpp_continuous \
  --mode eval
