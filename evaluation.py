...
try:
  ...
  INCEPTION_OUTPUT = None
  INCEPTION_FINAL_POOL = None
  _DEFAULT_DTYPES = None
  INCEPTION_DEFAULT_IMAGE_SIZE = None
...
if tf:
  ...
  def run_inception_jit(*args, **kwargs):
...
if tf:
  ...
  def run_inception_distributed(*args, **kwargs):
      raise NotImplementedError("TensorFlow not installed.")
